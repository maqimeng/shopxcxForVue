    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" align="center" label="角色名称" :formatter="formatter">
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('AdminRole/getRoleList', params, res => {
            ...
            saveEdit(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$api.post('AdminRole/saveAdminRole', params, res => {
                            this.getData();
            ...
            deleteRow(){
                ...
                this.$api.post('AdminRole/deleteAdminRole', params, res => {
                    this.getData();
