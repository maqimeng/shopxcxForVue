    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 内部码管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" align="center" label="标题" :formatter="formatter">
                </el-table-column>
                <el-table-column prop="content" align="center" label="内部码">
                </el-table-column>
                <el-table-column prop="number" align="center" label="砸蛋次数">
                </el-table-column>
                <el-table-column prop="startdatetime"  align="center" label="生成时间" sortable width="155">
                </el-table-column>
                <el-table-column prop="status" align="center" label="状态">
                </el-table-column>
                <el-table-column prop="enddatetime"  align="center" label="使用时间" sortable width="155">
                </el-table-column>
        ...
        <el-dialog title="编辑" v-loading="loading" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                ...
                <el-form-item label="砸蛋次数" prop="number">
                    <el-input v-model="form.number" placeholder="请输入砸蛋次数"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    number: [
                        { required: true, message: '请输入砸蛋次数', trigger: 'blur' }
                    ],
                }
            }
        },
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('InCode/getInCodeList', params, res => {
            ...
            saveEdit(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        // console.log(params);
                        // return;
                        this.$api.post('InCode/saveInCode', params, res => {
                            this.getData();
