    ...
    export default {
        ...
        data() {
            return {
                ...
                count:0,
                excelData:[],  //表格数据
                tHeader:['ID', '微信昵称', '性别', '省份', '城市', '手机号码', '更新时间'],
                tValue:['id', 'nickname', 'sex', 'province', 'city','tel','datetime'],
                filename:'砸金蛋所有参与者数据',
            }
        },
        created() {
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('Participant/getParticipantList', params, res => {
            ...
            exportExcel(){
                // console.log(111);
                this.$api.post('Participant/exportExcel', null, res => {
                    // console.log(res);
