    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 奖品管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="prize" align="center" label="奖品名称" :formatter="formatter">
                </el-table-column>
                <el-table-column prop="remarks" align="center" label="备注">
                </el-table-column>
                <el-table-column prop="v" align="center" label="中奖几率%" >
                </el-table-column>
        ...
        <el-dialog title="编辑" v-loading="loading" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                <el-form-item label="奖品名称" prop="prize">
                    <el-input v-model="form.prize" placeholder="请输入奖品名称"></el-input>
                </el-form-item>
                <el-form-item label="备注">
                    <el-input v-model="form.remarks" placeholder="请输入备注"></el-input>
                </el-form-item>
                <el-form-item label="中奖几率" prop="v">
                    <el-input v-model="form.v" placeholder="请输入中奖几率"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    v: [
                        { required: true, message: '请输入中奖几率', trigger: 'blur' }
                    ],
                }
            }
        },
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('Prize/getPrizeList', params, res => {
            ...
            saveEdit(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        // console.log(params);
                        // return;
                        this.$api.post('Prize/savePrize', params, res => {
                            this.getData();
                            this.$message.success(res.msg);
                        }, err => {
                            this.$message.error(err.msg);
            ...
            deleteRow(){
                ...
                this.$api.post('Prize/deletePrize', params, res => {
                    this.getData();
