    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 日记分类</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" align="center" label="分类名称">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="50%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                ...
                <el-form-item label="图片">
                    ...
                    <span style="color:red">建议尺寸132*132</span>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('ShopCaseMenu/getCaseMenuList', params, res => {
            ...
            saveEdit(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$api.post('ShopCaseMenu/saveCaseMenu', params, res => {
                            this.getData();
                            this.$message.success(res.msg);
                        }, err => {
                            this.$message.error(err.msg);
            ...
            deleteRow(){
                ...
                console.log(this.form);
                this.$api.post('ShopCaseMenu/deleteCaseMenu', params, res => {
                    this.getData();
