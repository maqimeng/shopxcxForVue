    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="date" label="预约日期" align="center" sortable>
                </el-table-column>

                <el-table-column prop="typename" align="center" label="困扰的问题">
                </el-table-column>
                <el-table-column prop="content" align="center" label="详细需求">
                </el-table-column>
                <el-table-column prop="mind" align="center" label="在意的问题">
                </el-table-column>
                <el-table-column prop="datetime" label="提交时间" align="center" sortable>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('ShopOnline/getOnlineList', params, res => {
