            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="130px">
                ...
                <el-form-item label="订单状态">
                    ...
                    <!--<template slot-scope="scope">-->
                        ...
                        <div v-else-if="form.status==4" style="color:#FF0000">退款中<el-button type="primary" @click="refund" style="margin-left: 10px;">已退款</el-button></div>
        ...
        methods: {
            ...
            refund(){
                ...
                this.$api.post('ShopOrder/saveOrderStatus', params, res => {
                    console.log(res);
                    this.form.status=5;
                    this.$message.success("订单状态修改为已退款状态，退款还需要您人工打款!");
                    this.getData();
                }, err => {
                    this.$message.error(err.msg);
                });
