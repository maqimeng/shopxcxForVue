    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 抽奖奖品</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="gift" align="center" label="奖品名称" :formatter="formatter">
                </el-table-column>
        ...
        <el-dialog title="编辑" v-loading="loading" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                <el-form-item label="奖品名称" prop="gift">
                    <el-input v-model="form.gift" placeholder="请输入奖品名称"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
            ...
            data() {
                return this.tableData.filter((d) => {
                    ...
                    for (let i = 0; i < this.del_list.length; i++) {
                        if (d.gift === this.del_list[i].gift) {
                            is_del = true;
                            break;
                        }
                    }
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('StepGift/getStepGiftList', params, res => {
            ...
            saveEdit(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        // console.log(params);
                        // return;
                        this.$api.post('StepGift/saveStepGift', params, res => {
                            this.getData();
                            this.$message.success(res.msg);
                        }, err => {
                            this.$message.error(err.msg);
            ...
            deleteRow(){
                ...
                this.$api.post('StepGift/deleteStepGift', params, res => {
                    this.getData();
