    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 内定中奖人员</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" style="float: right"  @click="handleEdit(undefined, undefined, 1)">添加内定中奖</el-button>
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column width="350" prop="gift" align="center" label="奖品名称">
                </el-table-column>
        ...
        <el-dialog title="编辑" v-loading="loading" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="100px">
                <el-form-item label="中奖用户">
                    <el-select v-model="selectedUser" placeholder="请选择中奖用户">
                        <el-option
                ...
                <el-form-item label="礼品">
                    <el-select v-model="selectedGift" placeholder="请选择礼品">
                        <el-option
                                v-for="item in giftList"
                                :key="item.id"
                                :label="item.gift"
                                :value="item.id">{{item.gift}}
                        </el-option>
                        <!--<el-option key="bbk" label="步步高" value="bbk"></el-option>-->
                        <!--<el-option key="xtc" label="小天才" value="xtc"></el-option>-->
                        <!--<el-option key="imoo" label="imoo" value="imoo"></el-option>-->
    ...
    export default {
        ...
        data() {
            return {
                ...
                count:0,
                excelData:[],  //表格数据
                tHeader:['ID', '微信昵称', '省份', '城市', '手机号码', '礼品名称', '更新时间'],
                tValue:['id', 'nickname', 'province', 'city','tel', 'gift', 'datetime'],
                filename:'健步挑战赛抽奖中奖名单',
                userList:[],  //微信用户列表
                giftList:[],  //奖品列表
                selectedUser:'',  //选中用户
                selectedGift:'',  //选中礼品
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('StepInYes/getInGiftList', params, res => {
            ...
            saveEdit(formName) {
                ...
                var params=this.$qs.stringify({
                    ...
                    giftid:this.selectedGift
                });
                this.$api.post('StepInYes/AddInGift', params, res => {
                    this.getData();
                    this.$message.success(res.msg);
                }, err => {
                    this.$message.error(err.msg);
            ...
            deleteRow(){
                ...
                console.log(this.form);
                this.$api.post('StepInYes/deleteInYes', params, res => {
                    this.getData();
            ...
            exportExcel(){
                // console.log(111);
                this.$api.post('StepInYes/exportExcel', null, res => {
                    // console.log(res);
            ...
            //获取微信用户列表
            getwechatUserList(){
                this.$api.post('StepInYes/wechatUserList', null, res => {
                    console.log(res);
            ...
            //获取礼品列表
            getGiftList(){
                this.$api.post('StepInYes/getGiftList', null, res => {
                    console.log(res);
