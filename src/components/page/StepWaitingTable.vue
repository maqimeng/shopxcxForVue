    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 等待抽奖名单</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="sumStep" align="center" label="总步数">
                </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                count:0,
                excelData:[],  //表格数据
                tHeader:['ID', '微信昵称', '性别', '省份', '城市', '手机号码','总步数', '更新时间'],
                tValue:['id', 'nickname', 'sex', 'province', 'city','tel','sumStep','datetime'],
                filename:'健步挑战赛等待抽奖名单',
            }
        },
        created() {
            //获取初始数据
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('StepWaiting/getStepWaitingList', params, res => {
            ...
            exportExcel(){
                // console.log(111);
                this.$api.post('StepWaiting/exportExcel', null, res => {
                    // console.log(res);
