    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 裂变用户管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="tel" align="center" label="手机号" >
                </el-table-column>
            ...
            data() {
                return this.tableData.filter((d) => {
                    ...
                    for (let i = 0; i < this.del_list.length; i++) {
                        if (d.nickname === this.del_list[i].nickname) {
                            is_del = true;
                            break;
                        }
                    }
        ...
        methods: {
            ...
            getData() {
                ...
                var params=this.$qs.stringify({
                    ...
                    number: this.number,
                    adminuserid:JSON.parse(localStorage.getItem('userInfo')).id
                });
                // console.log(params);
                // return;
                this.$api.post('MyWechatUser/getWechatUserList', params, res => {
