    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <export-excel style="float: right" :list="excelData" :filename="filename" :tHeader="tHeader" :tValue="tValue"></export-excel>
            </div>
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column type="selection" width="55" align="center"></el-table-column>
                <el-table-column prop="id" label="ID" width="70" align="center"></el-table-column>
                <el-table-column prop="nickname" align="center" label="微信昵称" :formatter="formatter">
                </el-table-column>
                <el-table-column prop="tel" align="center" label="手机号码">
                </el-table-column>
                <el-table-column prop="prize" align="center" label="奖品名称">
                </el-table-column>
                <el-table-column prop="code" align="center" label="兑换码">
                </el-table-column>
                <el-table-column prop="statusMsg" align="center" label="状态">
                </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                excelData:[],  //表格数据
                tHeader:['ID', '微信昵称', '手机号码', '奖品名称', '兑换码', '状态', '省份', '城市', '更新时间'],
                tValue:['id', 'nickname', 'tel', 'prize', 'code','statusMsg','province','city','datetime'],
                filename:'砸金蛋所有中奖名单数据',
            }
        },
        created() {
            //获取初始数据
        ...
        methods: {
            ...
            getData() {
                ...
                // console.log(params);
                this.$api.post('WinPrize/getWinPrizeList', params, res => {
            ...
            exportExcel(){
                // console.log(111);
                this.$api.post('WinPrize/exportExcel', null, res => {
                    // console.log(res);
